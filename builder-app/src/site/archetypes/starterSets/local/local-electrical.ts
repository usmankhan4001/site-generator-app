...
export const localElectrical: StarterContentSet = {
  ...
  business: {
    name: 'Volt',
    legalName: 'Vanguard Smart Electrical Contractors Pty Ltd',
    shortName: 'Volt',
    ...
    email: 'service@voltelectrical.example',
    phone: '+61 3 9429 8810',
    website: 'voltelectrical.example',
    supportHours: 'Monday – Friday, 07:00 – 17:30 • 24/7 Emergency On-Call',
  },
  brand: { logoText: 'Volt' },
  meta: {
    title: 'Volt — Licensed Master Electricians & Smart Home Specialists',
    description:
        ...
        items: [
          {
            ...
            rating: 5,
            text: 'Volt installed our Tesla Wall Connector and upgraded our 1970s switchboard to a modern RCBO setup. The cable runs through our garage ceiling are invisible and the team left the workspace spotless.',
          },
          {
            ...
            rating: 5,
            text: 'I regularly recommend Volt for all my residential renovation projects. Their understanding of architectural LED temperature, dimming protocols, and smart switching is second to none.',
          },
          {
            name: 'Liam Zhang',
            role: 'Property Owner',
