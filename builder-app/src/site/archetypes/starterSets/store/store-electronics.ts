...
export const storeElectronics: StarterContentSet = {
  ...
  themeId: 'midnight-audio',
  accent: '#d4a24e',
  business: {
    name: 'Sona',
    legalName: 'Sona Acoustic Labs Ltd',
    shortName: 'Sona',
    ...
    email: 'support@sona-audio.example',
    phone: '+44 20 7946 0741',
    website: 'sona-audio.example',
    supportHours: 'Monday – Friday, 09:00 – 17:30 (GMT)',
  },
  brand: { logoText: 'Sona' },
  meta: {
    title: 'Sona — High-Fidelity Audiophile Gear & Studio Electronics',
    description:
  ...
  slots: {
    home: {
      hero: {
        ...
        subtitle:
          'Sona designs planar magnetic reference headphones, flagship balanced DAC amplifiers, and nearfield studio monitors for audio engineers and discerning audiophiles.',
