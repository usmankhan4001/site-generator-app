...
const RAW: RawTheme[] = [
  ...
  {
    id: 'boutique-oat', name: 'Boutique & Oat', isDark: false,
    industry: 'Contemporary Fashion / Relaxed Tailoring Retail',
    fontDisplay: SERIF_EDITORIAL, fontSans: SANS_INTER, googleFonts: ['Playfair Display', 'Inter'],
    radius: '0.75rem', preview: { accent: '#b45309', bg: '#faf6ef', text: '#292019' },
    c: {
      primary: 'oklch(0.52 0.13 45)', primaryForeground: 'oklch(0.99 0 0)',
      background: 'oklch(0.985 0.005 80)', foreground: 'oklch(0.19 0.02 60)',
      card: 'oklch(1 0 0)', cardForeground: 'oklch(0.19 0.02 60)',
      muted: 'oklch(0.95 0.01 80)', mutedForeground: 'oklch(0.50 0.02 55)',
      accent: 'oklch(0.93 0.03 70)', accentForeground: 'oklch(0.38 0.11 45)',
      border: 'oklch(0.90 0.012 80)', ring: 'oklch(0.52 0.13 45)',
    },
  },
  {
    id: 'backcountry-olive', name: 'Backcountry Olive', isDark: true,
    industry: 'Outdoor / Trail & Alpine Equipment',
    fontDisplay: SANS_GROTESK, fontSans: SANS_INTER, googleFonts: ['Inter', 'Space Grotesk'],
    radius: '0.625rem', preview: { accent: '#a3e635', bg: '#12170e', text: '#f7fee7' },
    c: {
      primary: 'oklch(0.82 0.19 120)', primaryForeground: 'oklch(0.11 0.03 130)',
      background: 'oklch(0.13 0.02 130)', foreground: 'oklch(0.98 0 0)',
      card: 'oklch(0.18 0.025 130)', cardForeground: 'oklch(0.98 0 0)',
      muted: 'oklch(0.22 0.025 130)', mutedForeground: 'oklch(0.68 0.02 130)',
      accent: 'oklch(0.23 0.05 120)', accentForeground: 'oklch(0.88 0.12 120)',
      border: 'oklch(0.26 0.025 130)', ring: 'oklch(0.82 0.19 120)',
    },
  },
  {
    id: 'midnight-audio', name: 'Midnight Audio & Brass', isDark: true,
    industry: 'Audiophile Electronics / Hi-Fi Retail',
    fontDisplay: SANS_GROTESK, fontSans: SANS_INTER, googleFonts: ['Inter', 'Space Grotesk'],
    radius: '0.75rem', preview: { accent: '#d4a24e', bg: '#0c0a09', text: '#fafaf9' },
    c: {
      primary: 'oklch(0.78 0.11 80)', primaryForeground: 'oklch(0.10 0.02 60)',
      background: 'oklch(0.12 0.01 60)', foreground: 'oklch(0.98 0 0)',
      card: 'oklch(0.17 0.015 60)', cardForeground: 'oklch(0.98 0 0)',
      muted: 'oklch(0.21 0.015 60)', mutedForeground: 'oklch(0.66 0.015 60)',
      accent: 'oklch(0.24 0.03 70)', accentForeground: 'oklch(0.88 0.10 80)',
      border: 'oklch(0.24 0.015 60)', ring: 'oklch(0.78 0.11 80)',
    },
  },
  {
    id: 'noir-ivory', name: 'Noir & Ivory', isDark: true,
    industry: 'Haute Horlogerie / Luxury Timepieces',
    fontDisplay: SERIF_EDITORIAL, fontSans: SANS_INTER, googleFonts: ['Playfair Display', 'Inter'],
    radius: '0.5rem', preview: { accent: '#d4af37', bg: '#0a0a0a', text: '#f5f5f4' },
    c: {
      primary: 'oklch(0.80 0.12 95)', primaryForeground: 'oklch(0.10 0.01 90)',
      background: 'oklch(0.11 0.005 90)', foreground: 'oklch(0.98 0 0)',
      card: 'oklch(0.15 0.006 90)', cardForeground: 'oklch(0.98 0 0)',
      muted: 'oklch(0.19 0.008 90)', mutedForeground: 'oklch(0.66 0.01 90)',
      accent: 'oklch(0.22 0.02 85)', accentForeground: 'oklch(0.88 0.10 95)',
      border: 'oklch(0.24 0.008 90)', ring: 'oklch(0.80 0.12 95)',
    },
  },
  {
    id: 'bronze-atelier', name: 'Bronze Atelier', isDark: false,
    industry: 'Luxury Eyewear / Optical Atelier',
    fontDisplay: SERIF_EDITORIAL, fontSans: SANS_INTER, googleFonts: ['Playfair Display', 'Inter'],
    radius: '0.5rem', preview: { accent: '#92603d', bg: '#faf7f2', text: '#201a15' },
    c: {
      primary: 'oklch(0.47 0.09 55)', primaryForeground: 'oklch(0.99 0 0)',
      background: 'oklch(0.985 0.006 70)', foreground: 'oklch(0.18 0.02 60)',
      card: 'oklch(1 0 0)', cardForeground: 'oklch(0.18 0.02 60)',
      muted: 'oklch(0.95 0.008 70)', mutedForeground: 'oklch(0.49 0.02 60)',
      accent: 'oklch(0.92 0.02 70)', accentForeground: 'oklch(0.33 0.06 55)',
      border: 'oklch(0.90 0.01 70)', ring: 'oklch(0.47 0.09 55)',
    },
  },
  {
    id: 'saddle-oak', name: 'Saddle Oak', isDark: false,
    industry: 'Artisanal Leather Goods / Luxury Craft',
    fontDisplay: SERIF_EDITORIAL, fontSans: SANS_INTER, googleFonts: ['Playfair Display', 'Inter'],
    radius: '0.5rem', preview: { accent: '#92400e', bg: '#fbf7f0', text: '#2a1f14' },
    c: {
      primary: 'oklch(0.44 0.10 50)', primaryForeground: 'oklch(0.99 0 0)',
      background: 'oklch(0.985 0.008 80)', foreground: 'oklch(0.20 0.03 60)',
      card: 'oklch(1 0 0)', cardForeground: 'oklch(0.20 0.03 60)',
      muted: 'oklch(0.95 0.012 75)', mutedForeground: 'oklch(0.49 0.03 60)',
      accent: 'oklch(0.93 0.03 75)', accentForeground: 'oklch(0.33 0.08 50)',
      border: 'oklch(0.90 0.012 75)', ring: 'oklch(0.44 0.10 50)',
    },
  },
  {
    id: 'highvis-amber', name: 'High-Vis Amber', isDark: true,
    industry: 'Heavy Civil Infrastructure / EPC Engineering',
    fontDisplay: SANS_GROTESK, fontSans: SANS_INTER, googleFonts: ['Inter', 'Space Grotesk'],
    radius: '0.625rem', preview: { accent: '#f59e0b', bg: '#131311', text: '#fefce8' },
    c: {
      primary: 'oklch(0.79 0.16 75)', primaryForeground: 'oklch(0.10 0.02 70)',
      background: 'oklch(0.13 0.01 70)', foreground: 'oklch(0.98 0 0)',
      card: 'oklch(0.18 0.015 70)', cardForeground: 'oklch(0.98 0 0)',
      muted: 'oklch(0.22 0.015 70)', mutedForeground: 'oklch(0.68 0.02 70)',
      accent: 'oklch(0.24 0.04 75)', accentForeground: 'oklch(0.90 0.12 75)',
      border: 'oklch(0.26 0.015 70)', ring: 'oklch(0.79 0.16 75)',
    },
  },
  {
    id: 'trade-slate', name: 'Trade Slate', isDark: false,
    industry: 'Local Trade / Contractor Services',
    fontDisplay: SANS_JAKARTA, fontSans: SANS_INTER, googleFonts: ['Plus Jakarta Sans', 'Inter'],
    radius: '0.625rem', preview: { accent: '#ea580c', bg: '#f5f7f9', text: '#1a2430' },
    c: {
      primary: 'oklch(0.40 0.03 255)', primaryForeground: 'oklch(0.99 0 0)',
      background: 'oklch(0.987 0.003 250)', foreground: 'oklch(0.16 0.02 255)',
      card: 'oklch(1 0 0)', cardForeground: 'oklch(0.16 0.02 255)',
      muted: 'oklch(0.95 0.006 250)', mutedForeground: 'oklch(0.48 0.02 255)',
      accent: 'oklch(0.94 0.03 55)', accentForeground: 'oklch(0.40 0.13 55)',
      border: 'oklch(0.90 0.006 250)', ring: 'oklch(0.40 0.03 255)',
    },
  },
];
