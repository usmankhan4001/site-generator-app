...
export interface Pricing04_SowRetainerTableProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing04_SowRetainerTable: React.FC<Pricing04_SowRetainerTableProps> = ({
  badge = 'Advisory Retainers',
  headline = 'SOW Advisory & Retainer Table',
  description = 'Professional services retainer layout detailing SLA response hours, partner advisory, and dedicated squad.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing04_SowRetainerTable;
