...
export interface Pricing01_TieredSaaS3CardsProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing01_TieredSaaS3Cards: React.FC<Pricing01_TieredSaaS3CardsProps> = ({
  badge = 'Subscription Tiers',
  headline = '3-Tier SaaS Comparison Cards',
  description = 'Standard Starter, Growth, and Scale plans with feature checklists and highlighted popular badge.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing01_TieredSaaS3Cards;
