...
export interface Pricing11_PayAsYouGoMeterProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing11_PayAsYouGoMeter: React.FC<Pricing11_PayAsYouGoMeterProps> = ({
  badge = 'Interchange Plus',
  headline = 'Metered Gateway Rate Card',
  description = 'Transparent domestic and cross-border payment processing percentage breakdown with no monthly minimum.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing11_PayAsYouGoMeter;
