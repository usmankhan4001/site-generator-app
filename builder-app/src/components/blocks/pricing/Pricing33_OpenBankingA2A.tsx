...
export interface Pricing33_OpenBankingA2AProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing33_OpenBankingA2A: React.FC<Pricing33_OpenBankingA2AProps> = ({
  badge = 'Pay by Bank',
  headline = 'Open Banking & Direct Account-to-Account',
  description = 'Low-cost direct account transfer pricing eliminating interchange card scheme fees.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing33_OpenBankingA2A;
