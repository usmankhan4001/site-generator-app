...
export interface Pricing14_AddonAdditivesProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing14_AddonAdditives: React.FC<Pricing14_AddonAdditivesProps> = ({
  badge = 'Configurable Add-Ons',
  headline = 'Modular Add-On Micro-Packages',
  description = 'Granular modular modules: Dedicated IP, Fraud Shield Plus, Custom Domains, and Audit Logs.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing14_AddonAdditives;
