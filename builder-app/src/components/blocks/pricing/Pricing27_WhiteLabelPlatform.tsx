...
export interface Pricing27_WhiteLabelPlatformProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing27_WhiteLabelPlatform: React.FC<Pricing27_WhiteLabelPlatformProps> = ({
  badge = 'Platform Whitelabel',
  headline = 'Full Whitelabel & Rebranding License',
  description = 'Commercial whitelabel tier allowing branded merchant portals, iOS/Android apps, and sub-domains.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing27_WhiteLabelPlatform;
