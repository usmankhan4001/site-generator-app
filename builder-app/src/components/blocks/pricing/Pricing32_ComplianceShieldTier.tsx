...
export interface Pricing32_ComplianceShieldTierProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing32_ComplianceShieldTier: React.FC<Pricing32_ComplianceShieldTierProps> = ({
  badge = 'Fraud Mitigation',
  headline = 'Turnkey KYC & Anti-Fraud Shield',
  description = 'Chargeback guarantee tier with biometric 3DS2 protection and automated dispute dispute filing.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing32_ComplianceShieldTier;
