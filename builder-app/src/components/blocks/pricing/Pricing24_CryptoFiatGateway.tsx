...
export interface Pricing24_CryptoFiatGatewayProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing24_CryptoFiatGateway: React.FC<Pricing24_CryptoFiatGatewayProps> = ({
  badge = 'Hybrid Rails',
  headline = 'Web3 & Fiat Settlement Dual Tier',
  description = 'Parallel pricing tiers for instant stablecoin settlement alongside traditional SWIFT/FedNow.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing24_CryptoFiatGateway;
