...
export interface Pricing16_MultiCurrencyTableProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing16_MultiCurrencyTable: React.FC<Pricing16_MultiCurrencyTableProps> = ({
  badge = 'Foreign Exchange',
  headline = 'Multi-Currency Global Payout Rates',
  description = 'FX markup table comparing USD, EUR, GBP, SGD, and AUD wire transfer settlement schedules.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing16_MultiCurrencyTable;
