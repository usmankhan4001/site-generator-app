...
export interface Pricing18_PerSeatCollaborativeProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing18_PerSeatCollaborative: React.FC<Pricing18_PerSeatCollaborativeProps> = ({
  badge = 'Team Licensing',
  headline = 'Per-Seat Operator Pricing Grid',
  description = 'Predictable cost modeling calculated per operator seat with role-based governance tiers.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing18_PerSeatCollaborative;
