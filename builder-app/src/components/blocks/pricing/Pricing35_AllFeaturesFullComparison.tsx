...
export interface Pricing35_AllFeaturesFullComparisonProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing35_AllFeaturesFullComparison: React.FC<Pricing35_AllFeaturesFullComparisonProps> = ({
  badge = 'Full Breakdown',
  headline = 'Comprehensive Master Specification Sheet',
  description = 'Exhaustive horizontal comparison sheet cross-referencing 40+ statutory compliance controls.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing35_AllFeaturesFullComparison;
