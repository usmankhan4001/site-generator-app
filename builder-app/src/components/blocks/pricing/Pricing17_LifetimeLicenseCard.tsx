...
export interface Pricing17_LifetimeLicenseCardProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing17_LifetimeLicenseCard: React.FC<Pricing17_LifetimeLicenseCardProps> = ({
  badge = 'Single Payment',
  headline = 'Lifetime Commercial License',
  description = 'One-time investment tier providing permanent self-hosted source code access and unlimited clusters.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing17_LifetimeLicenseCard;
