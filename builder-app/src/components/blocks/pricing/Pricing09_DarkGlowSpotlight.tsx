...
export interface Pricing09_DarkGlowSpotlightProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing09_DarkGlowSpotlight: React.FC<Pricing09_DarkGlowSpotlightProps> = ({
  badge = 'Signature Offering',
  headline = 'Dark Mode Glow Spotlight Pricing',
  description = 'Deep zinc cards with glowing purple-indigo border radiance on the recommended tier.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing09_DarkGlowSpotlight;
