...
export interface Pricing25_BespokeEnterpriseQuoteProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing25_BespokeEnterpriseQuote: React.FC<Pricing25_BespokeEnterpriseQuoteProps> = ({
  badge = 'Bespoke Quote',
  headline = 'Custom Architecture Architecture Quote',
  description = 'Enterprise procurement layout with custom questionnaire trigger and solution architect routing.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing25_BespokeEnterpriseQuote;
