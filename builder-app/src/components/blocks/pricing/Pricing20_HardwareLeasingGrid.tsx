...
export interface Pricing20_HardwareLeasingGridProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing20_HardwareLeasingGrid: React.FC<Pricing20_HardwareLeasingGridProps> = ({
  badge = 'Hardware Leasing',
  headline = 'POS Terminal & Terminal Hardware Grid',
  description = 'Point of sale terminal models, wireless smart readers, and monthly countertop rental bundles.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing20_HardwareLeasingGrid;
