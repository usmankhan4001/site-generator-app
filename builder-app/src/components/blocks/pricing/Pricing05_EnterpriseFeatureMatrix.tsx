...
export interface Pricing05_EnterpriseFeatureMatrixProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing05_EnterpriseFeatureMatrix: React.FC<Pricing05_EnterpriseFeatureMatrixProps> = ({
  badge = 'Institutional Audit',
  headline = 'Comprehensive Feature Comparison Matrix',
  description = 'Full matrix table checking security compliance, API limits, SAML SSO, and custom legal addenda.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing05_EnterpriseFeatureMatrix;
