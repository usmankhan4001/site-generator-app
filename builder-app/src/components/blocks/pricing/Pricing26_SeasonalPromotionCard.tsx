...
export interface Pricing26_SeasonalPromotionCardProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing26_SeasonalPromotionCard: React.FC<Pricing26_SeasonalPromotionCardProps> = ({
  badge = 'Limited Opportunity',
  headline = 'Seasonal Merchant Discount Banner',
  description = 'Time-sensitive promotion offering 0% merchant processing fees for the first 90 operating days.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing26_SeasonalPromotionCard;
