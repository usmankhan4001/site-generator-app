...
export interface Pricing30_CorporateTreasuryProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing30_CorporateTreasury: React.FC<Pricing30_CorporateTreasuryProps> = ({
  badge = 'Corporate Treasury',
  headline = 'Global Treasury & Yield Management',
  description = 'High-yield operational account tiers with multi-entity automated sweep and liquidity routing.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing30_CorporateTreasury;
