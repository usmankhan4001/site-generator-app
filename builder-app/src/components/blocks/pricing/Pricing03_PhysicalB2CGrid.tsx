...
export interface Pricing03_PhysicalB2CGridProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing03_PhysicalB2CGrid: React.FC<Pricing03_PhysicalB2CGridProps> = ({
  badge = 'Direct-to-Consumer',
  headline = 'Physical B2C Product Card Grid',
  description = 'E-commerce showcase featuring product imagery, SKU dimensions, inventory alerts, and instant cart triggers.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing03_PhysicalB2CGrid;
