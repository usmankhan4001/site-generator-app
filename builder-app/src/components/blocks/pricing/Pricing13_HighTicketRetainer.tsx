...
export interface Pricing13_HighTicketRetainerProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing13_HighTicketRetainer: React.FC<Pricing13_HighTicketRetainerProps> = ({
  badge = 'Private Retainer',
  headline = 'Executive Master Retainer & Escrow',
  description = 'Dedicated institutional banking retainers with escrow settlement guarantees.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing13_HighTicketRetainer;
