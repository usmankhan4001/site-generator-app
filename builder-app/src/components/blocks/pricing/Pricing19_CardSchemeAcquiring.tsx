...
export interface Pricing19_CardSchemeAcquiringProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing19_CardSchemeAcquiring: React.FC<Pricing19_CardSchemeAcquiringProps> = ({
  badge = 'Card Acquiring',
  headline = 'Direct Scheme Interchange Cards',
  description = 'Clear Visa, Mastercard, AMEX, and UnionPay merchant pass-through acquiring rates.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing19_CardSchemeAcquiring;
