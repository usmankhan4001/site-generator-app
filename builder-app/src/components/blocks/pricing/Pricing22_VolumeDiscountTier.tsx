...
export interface Pricing22_VolumeDiscountTierProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing22_VolumeDiscountTier: React.FC<Pricing22_VolumeDiscountTierProps> = ({
  badge = 'Scale Savings',
  headline = 'Tiered Volume Discount Progression',
  description = 'Progressive tiers illustrating volume fee reductions as monthly gross merchant volume scales.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing22_VolumeDiscountTier;
