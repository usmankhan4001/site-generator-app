...
export interface Pricing15_FreeTrialBannerProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing15_FreeTrialBanner: React.FC<Pricing15_FreeTrialBannerProps> = ({
  badge = 'Instant Sandboxing',
  headline = 'Zero-Risk 14-Day Free Trial Tier',
  description = 'Free trial card highlighting instantaneous testnet credentials with no upfront payment card required.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing15_FreeTrialBanner;
