...
export interface Pricing34_CustomDeploymentPaaSProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing34_CustomDeploymentPaaS: React.FC<Pricing34_CustomDeploymentPaaSProps> = ({
  badge = 'Air-Gapped Cloud',
  headline = 'Self-Hosted Sovereign Cloud Cluster',
  description = 'Deployment tier for on-premise Kubernetes clusters, Dokploy PaaS, and private cloud VPCs.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing34_CustomDeploymentPaaS;
