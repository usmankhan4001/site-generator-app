...
export interface Pricing12_StartupDiscountTierProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing12_StartupDiscountTier: React.FC<Pricing12_StartupDiscountTierProps> = ({
  badge = 'Founder Perk',
  headline = 'Accelerated Founder & Seed Program',
  description = 'Special concessionary pricing tier with $100k in waived transaction credits for venture-backed teams.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing12_StartupDiscountTier;
