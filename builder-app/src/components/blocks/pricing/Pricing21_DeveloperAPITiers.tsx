...
export interface Pricing21_DeveloperAPITiersProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing21_DeveloperAPITiers: React.FC<Pricing21_DeveloperAPITiersProps> = ({
  badge = 'API Limits',
  headline = 'Developer Tier & Webhook Quotas',
  description = 'Rate-limit breakdown for sandbox, production API calls, batch reconciliation, and webhooks.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing21_DeveloperAPITiers;
