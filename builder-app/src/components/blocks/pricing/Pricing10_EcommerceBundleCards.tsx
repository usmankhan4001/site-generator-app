...
export interface Pricing10_EcommerceBundleCardsProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing10_EcommerceBundleCards: React.FC<Pricing10_EcommerceBundleCardsProps> = ({
  badge = 'Turnkey Bundles',
  headline = 'Omnichannel Merchant Package Bundles',
  description = 'Packaged retail checkout, point-of-sale terminal sync, and merchant acquiring bundles.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing10_EcommerceBundleCards;
