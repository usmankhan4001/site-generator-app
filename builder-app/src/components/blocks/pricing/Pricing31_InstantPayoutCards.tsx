...
export interface Pricing31_InstantPayoutCardsProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing31_InstantPayoutCards: React.FC<Pricing31_InstantPayoutCardsProps> = ({
  badge = 'Real-Time Liquidity',
  headline = 'Accelerated T+0 Instant Payout Cards',
  description = 'Instant merchant payout cards featuring nominal 1% real-time liquidity transfer fees.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing31_InstantPayoutCards;
