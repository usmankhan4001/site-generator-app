...
export interface Pricing08_FourTierCorporateProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing08_FourTierCorporate: React.FC<Pricing08_FourTierCorporateProps> = ({
  badge = 'Institutional Solutions',
  headline = '4-Column Corporate Tier Matrix',
  description = 'Starter, Business, Scale, and Custom Enterprise tiers for multi-national businesses.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing08_FourTierCorporate;
