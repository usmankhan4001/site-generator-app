...
export interface Pricing02_MonthlyAnnualSwitchProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing02_MonthlyAnnualSwitch: React.FC<Pricing02_MonthlyAnnualSwitchProps> = ({
  badge = 'Save 20% Annual',
  headline = 'Billing Cadence Switcher (Monthly/Annual)',
  description = 'Interactive billing toggle offering 2 months free with seamless annual discount calculation.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing02_MonthlyAnnualSwitch;
