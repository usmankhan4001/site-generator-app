...
export interface Pricing23_DedicatedSLAContractProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing23_DedicatedSLAContract: React.FC<Pricing23_DedicatedSLAContractProps> = ({
  badge = 'Mission Critical',
  headline = 'Mission-Critical 99.999% SLA Tier',
  description = 'Financial SLA tier with dedicated Slack war room and 15-minute engineer response guarantees.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing23_DedicatedSLAContract;
