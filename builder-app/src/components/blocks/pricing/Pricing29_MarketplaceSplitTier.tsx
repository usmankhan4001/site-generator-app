...
export interface Pricing29_MarketplaceSplitTierProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing29_MarketplaceSplitTier: React.FC<Pricing29_MarketplaceSplitTierProps> = ({
  badge = 'Marketplace Splits',
  headline = 'Multi-Vendor Marketplace Escrow Tier',
  description = 'Dynamic payout splitting, automated 1099-K tax reporting, and nested merchant onboarding.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing29_MarketplaceSplitTier;
