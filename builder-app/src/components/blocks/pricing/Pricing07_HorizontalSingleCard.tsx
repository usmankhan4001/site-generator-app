...
export interface Pricing07_HorizontalSingleCardProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Pricing07_HorizontalSingleCard: React.FC<Pricing07_HorizontalSingleCardProps> = ({
  badge = 'Transparent Pricing',
  headline = 'All-Inclusive Single Plan Banner',
  description = 'One high-impact card containing everything needed to deploy and scale without feature gating.',
  annualBilling = false,
  plans = [
    {
      id: 'tier-starter',
...
export default Pricing07_HorizontalSingleCard;
