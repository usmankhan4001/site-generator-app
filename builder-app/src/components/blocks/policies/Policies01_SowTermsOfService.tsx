...
export interface Policies01_SowTermsOfServiceProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies01_SowTermsOfService: React.FC<Policies01_SowTermsOfServiceProps> = ({
  badge = 'Statutory SOW',
  title = 'SOW Advisory & Services Agreement',
...
export default Policies01_SowTermsOfService;
