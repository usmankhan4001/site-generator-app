...
export interface Policies06_AcceptableUsePolicyProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies06_AcceptableUsePolicy: React.FC<Policies06_AcceptableUsePolicyProps> = ({
...
export default Policies06_AcceptableUsePolicy;
