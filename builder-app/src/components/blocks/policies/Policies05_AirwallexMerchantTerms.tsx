...
export interface Policies05_AirwallexMerchantTermsProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies05_AirwallexMerchantTerms: React.FC<Policies05_AirwallexMerchantTermsProps> = ({
  badge = 'Merchant Agreement',
  title = 'Payment Processing & Underwriting Terms',
...
export default Policies05_AirwallexMerchantTerms;
