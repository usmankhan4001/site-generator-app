...
export interface Policies12_SubprocessorsListProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies12_SubprocessorsList: React.FC<Policies12_SubprocessorsListProps> = ({
  badge = 'Vendor Register',
  title = 'Third-Party Subprocessors & Vendor Register',
...
export default Policies12_SubprocessorsList;
