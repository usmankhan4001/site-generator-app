...
export interface Policies08_ShippingFreightPolicyProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies08_ShippingFreightPolicy: React.FC<Policies08_ShippingFreightPolicyProps> = ({
  badge = 'Logistics Terms',
  title = 'Global Shipping, Customs & Delivery Policy',
...
export default Policies08_ShippingFreightPolicy;
