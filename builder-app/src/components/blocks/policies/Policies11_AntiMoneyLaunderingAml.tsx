...
export interface Policies11_AntiMoneyLaunderingAmlProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies11_AntiMoneyLaunderingAml: React.FC<Policies11_AntiMoneyLaunderingAmlProps> = ({
  badge = 'FinCrime Prevention',
  title = 'Anti-Money Laundering (AML) & Sanctions Statement',
...
export default Policies11_AntiMoneyLaunderingAml;
