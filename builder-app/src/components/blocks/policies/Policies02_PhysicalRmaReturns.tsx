...
export interface Policies02_PhysicalRmaReturnsProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies02_PhysicalRmaReturns: React.FC<Policies02_PhysicalRmaReturnsProps> = ({
  badge = 'Returns & Refunds',
  title = 'Physical Goods RMA & 30-Day Returns Policy',
...
export default Policies02_PhysicalRmaReturns;
