...
export interface Policies09_CookiePolicyAndTrackingProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies09_CookiePolicyAndTracking: React.FC<Policies09_CookiePolicyAndTrackingProps> = ({
  badge = 'Cookie Disclosure',
  title = 'Cookie Policy & Web Tracking Disclosure',
...
export default Policies09_CookiePolicyAndTracking;
