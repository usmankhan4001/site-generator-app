...
export interface Policies15_MasterServiceAgreementProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies15_MasterServiceAgreement: React.FC<Policies15_MasterServiceAgreementProps> = ({
  badge = 'Master Agreement',
  title = 'Master Services Agreement (MSA) Full Framework',
...
export default Policies15_MasterServiceAgreement;
