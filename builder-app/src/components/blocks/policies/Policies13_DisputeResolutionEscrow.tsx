...
export interface Policies13_DisputeResolutionEscrowProps {
  badge?: string;
  title?: string;
  lastUpdated?: string;
  governingLaw?: string;
...
export const Policies13_DisputeResolutionEscrow: React.FC<Policies13_DisputeResolutionEscrowProps> = ({
  badge = 'Arbitration & Escrow',
  title = 'Dispute Resolution & Escrow Settlement Rules',
...
export default Policies13_DisputeResolutionEscrow;
