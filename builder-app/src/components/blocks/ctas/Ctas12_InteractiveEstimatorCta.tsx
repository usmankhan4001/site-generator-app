...
export interface Ctas12_InteractiveEstimatorCtaProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas12_InteractiveEstimatorCta: React.FC<Ctas12_InteractiveEstimatorCtaProps> = ({
  badge = 'Instant Estimate',
  headline = 'Interactive Pricing Estimator CTA',
  description = 'Simple slider estimating monthly savings before triggering the signup action.',
...
export default Ctas12_InteractiveEstimatorCta;
