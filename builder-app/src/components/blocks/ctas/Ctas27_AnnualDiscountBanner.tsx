...
export interface Ctas27_AnnualDiscountBannerProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas27_AnnualDiscountBanner: React.FC<Ctas27_AnnualDiscountBannerProps> = ({
  badge = 'Annual Savings',
  headline = 'Switch to Annual Billing & Save 20%',
  description = 'One-click upgrade banner applying 2 free months on all annual subscription commitments.',
...
export default Ctas27_AnnualDiscountBanner;
