...
export interface Ctas20_WhiteLabelResellerTriggerProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas20_WhiteLabelResellerTrigger: React.FC<Ctas20_WhiteLabelResellerTriggerProps> = ({
  badge = 'Reseller Program',
  headline = 'Become an Authorized Whitelabel Partner',
  description = 'Application prompt for digital agencies seeking recurring interchange revenue share.',
...
export default Ctas20_WhiteLabelResellerTrigger;
