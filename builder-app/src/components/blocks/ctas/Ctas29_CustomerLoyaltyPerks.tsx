...
export interface Ctas29_CustomerLoyaltyPerksProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas29_CustomerLoyaltyPerks: React.FC<Ctas29_CustomerLoyaltyPerksProps> = ({
  badge = 'VIP Merchant Club',
  headline = 'Unlock VIP Merchant Tier Benefits',
  description = 'Incentive program offering preferential exchange rates and dedicated account managers.',
...
export default Ctas29_CustomerLoyaltyPerks;
