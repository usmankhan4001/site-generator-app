...
export interface Ctas04_FreeTrialInstantAccessProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas04_FreeTrialInstantAccess: React.FC<Ctas04_FreeTrialInstantAccessProps> = ({
  badge = 'Zero Friction',
  headline = 'Instant Free Trial & Sandbox Provisioning',
  description = 'Instant access button granting API test keys with no credit card requirement.',
...
export default Ctas04_FreeTrialInstantAccess;
