...
export interface Ctas19_GuaranteedMoneyBackProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas19_GuaranteedMoneyBack: React.FC<Ctas19_GuaranteedMoneyBackProps> = ({
  badge = 'Satisfaction Guaranteed',
  headline = '100% Risk-Free 30-Day Guarantee Banner',
  description = 'Reassurance banner detailing no-questions-asked refund guarantees.',
...
export default Ctas19_GuaranteedMoneyBack;
