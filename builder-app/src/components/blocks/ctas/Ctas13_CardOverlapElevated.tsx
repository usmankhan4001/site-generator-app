...
export interface Ctas13_CardOverlapElevatedProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas13_CardOverlapElevated: React.FC<Ctas13_CardOverlapElevatedProps> = ({
  badge = 'Next Steps',
  headline = 'Elevated Floating Card CTA',
  description = 'Shadow-elevated card floating over section boundaries for elevated visual focus.',
...
export default Ctas13_CardOverlapElevated;
