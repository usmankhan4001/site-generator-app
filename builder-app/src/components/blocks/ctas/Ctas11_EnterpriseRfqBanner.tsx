...
export interface Ctas11_EnterpriseRfqBannerProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas11_EnterpriseRfqBanner: React.FC<Ctas11_EnterpriseRfqBannerProps> = ({
  badge = 'Enterprise Scale',
  headline = 'Custom Enterprise Architecture RFQ',
  description = 'Tailored prompt targeting teams with over $10M in annual transaction throughput.',
...
export default Ctas11_EnterpriseRfqBanner;
