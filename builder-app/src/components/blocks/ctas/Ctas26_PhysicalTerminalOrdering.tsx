...
export interface Ctas26_PhysicalTerminalOrderingProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas26_PhysicalTerminalOrdering: React.FC<Ctas26_PhysicalTerminalOrderingProps> = ({
  badge = 'Hardware Ready',
  headline = 'Order POS Smart Hardware Today',
  description = 'Immediate checkout trigger for countertop smart payment terminals with 2-day delivery.',
...
export default Ctas26_PhysicalTerminalOrdering;
