...
export interface Ctas10_AppStoreMobilePromptProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas10_AppStoreMobilePrompt: React.FC<Ctas10_AppStoreMobilePromptProps> = ({
  badge = 'Download App',
  headline = 'Mobile App Store Onboarding Prompt',
  description = 'QR code scan and direct app store links to download merchant management apps.',
...
export default Ctas10_AppStoreMobilePrompt;
