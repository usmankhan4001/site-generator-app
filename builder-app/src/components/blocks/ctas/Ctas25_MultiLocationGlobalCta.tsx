...
export interface Ctas25_MultiLocationGlobalCtaProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas25_MultiLocationGlobalCta: React.FC<Ctas25_MultiLocationGlobalCtaProps> = ({
  badge = 'Global Edge',
  headline = 'Deploy to 35+ Edge Regions Worldwide',
  description = 'Interactive world map background showcasing multi-region edge deployment.',
...
export default Ctas25_MultiLocationGlobalCta;
