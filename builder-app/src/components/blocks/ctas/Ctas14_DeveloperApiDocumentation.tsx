...
export interface Ctas14_DeveloperApiDocumentationProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas14_DeveloperApiDocumentation: React.FC<Ctas14_DeveloperApiDocumentationProps> = ({
  badge = 'For Developers',
  headline = 'Read Developer Docs & Test Sandbox',
  description = 'Engineering-first prompt offering curl commands and sandbox API keys.',
...
export default Ctas14_DeveloperApiDocumentation;
