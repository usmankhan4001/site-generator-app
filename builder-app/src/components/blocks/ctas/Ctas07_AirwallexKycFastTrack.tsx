...
export interface Ctas07_AirwallexKycFastTrackProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas07_AirwallexKycFastTrack: React.FC<Ctas07_AirwallexKycFastTrackProps> = ({
  badge = 'Instant Settlement',
  headline = 'Airwallex Fast-Track Account Activation',
  description = 'Onboarding CTA tailored for immediate payment processing and compliance clearance.',
...
export default Ctas07_AirwallexKycFastTrack;
