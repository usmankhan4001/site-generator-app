...
export interface Ctas01_DarkModeBannerProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas01_DarkModeBanner: React.FC<Ctas01_DarkModeBannerProps> = ({
  badge = 'Institutional Power',
  headline = 'Dark Mode High-Contrast Banner',
  description = 'Deep zinc background with vibrant purple button and clear value proposition.',
...
export default Ctas01_DarkModeBanner;
