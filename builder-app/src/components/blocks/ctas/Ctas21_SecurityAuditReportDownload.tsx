...
export interface Ctas21_SecurityAuditReportDownloadProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas21_SecurityAuditReportDownload: React.FC<Ctas21_SecurityAuditReportDownloadProps> = ({
  badge = 'SOC2 & Security',
  headline = 'Download Comprehensive Security Whitepaper',
  description = 'Gated PDF download providing full SOC2 Type II audit summary and architecture diagrams.',
...
export default Ctas21_SecurityAuditReportDownload;
