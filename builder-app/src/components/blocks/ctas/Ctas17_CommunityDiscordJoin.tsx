...
export interface Ctas17_CommunityDiscordJoinProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas17_CommunityDiscordJoin: React.FC<Ctas17_CommunityDiscordJoinProps> = ({
  badge = 'Global Community',
  headline = 'Join 12,000+ Builder Community',
  description = 'Social invitation to join the official Discord server, GitHub organization, and forums.',
...
export default Ctas17_CommunityDiscordJoin;
