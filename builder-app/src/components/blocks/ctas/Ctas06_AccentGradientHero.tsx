...
export interface Ctas06_AccentGradientHeroProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas06_AccentGradientHero: React.FC<Ctas06_AccentGradientHeroProps> = ({
  badge = 'Accelerate Velocity',
  headline = 'Vibrant Accent Gradient Banner',
  description = 'Full-bleed brand accent gradient with high-contrast white action buttons.',
...
export default Ctas06_AccentGradientHero;
