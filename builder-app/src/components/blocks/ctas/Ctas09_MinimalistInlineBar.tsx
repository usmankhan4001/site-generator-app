...
export interface Ctas09_MinimalistInlineBarProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas09_MinimalistInlineBar: React.FC<Ctas09_MinimalistInlineBarProps> = ({
  badge = 'Get Started',
  headline = 'Minimalist Clean Bar CTA',
  description = 'Clean, space-efficient horizontal bar linking directly into the checkout checkout sheet.',
...
export default Ctas09_MinimalistInlineBar;
