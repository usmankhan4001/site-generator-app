...
export interface Ctas05_SplitCardWithMetricsProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas05_SplitCardWithMetrics: React.FC<Ctas05_SplitCardWithMetricsProps> = ({
  badge = 'Validated Velocity',
  headline = 'Split CTA with Performance Proof Points',
  description = 'Action prompt flanked by live uptime counters and average deployment speed stats.',
...
export default Ctas05_SplitCardWithMetrics;
