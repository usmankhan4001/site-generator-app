...
export interface Ctas03_ConsultationTriggerProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas03_ConsultationTrigger: React.FC<Ctas03_ConsultationTriggerProps> = ({
  badge = 'Speak with Leadership',
  headline = 'Executive Consultation & Meeting Trigger',
  description = 'Direct invitation to schedule a confidential 30-minute commercial architecture session.',
...
export default Ctas03_ConsultationTrigger;
