...
export interface Ctas15_UrgentLimitedWindowProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas15_UrgentLimitedWindow: React.FC<Ctas15_UrgentLimitedWindowProps> = ({
  badge = 'Limited Availability',
  headline = 'Time-Limited Founder Onboarding Perk',
  description = 'Countdown indicator offering waived interchange fees for the next 50 approved applicants.',
...
export default Ctas15_UrgentLimitedWindow;
