...
export interface Ctas24_InvestorPitchDeckRequestProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas24_InvestorPitchDeckRequest: React.FC<Ctas24_InvestorPitchDeckRequestProps> = ({
  badge = 'Investor Access',
  headline = 'Request Institutional Investor Materials',
  description = 'Direct portal for sovereign funds and qualified institutional buyers.',
...
export default Ctas24_InvestorPitchDeckRequest;
