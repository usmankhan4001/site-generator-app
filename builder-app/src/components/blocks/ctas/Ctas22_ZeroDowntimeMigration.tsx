...
export interface Ctas22_ZeroDowntimeMigrationProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas22_ZeroDowntimeMigration: React.FC<Ctas22_ZeroDowntimeMigrationProps> = ({
  badge = 'Free Migration',
  headline = 'Migrate from Legacy Rails in 48 Hours',
  description = 'Turnkey migration prompt with free data migration and integration engineers.',
...
export default Ctas22_ZeroDowntimeMigration;
