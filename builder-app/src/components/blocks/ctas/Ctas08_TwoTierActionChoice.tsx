...
export interface Ctas08_TwoTierActionChoiceProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas08_TwoTierActionChoice: React.FC<Ctas08_TwoTierActionChoiceProps> = ({
  badge = 'Choose Your Path',
  headline = 'Dual Action: Explore Demo or Buy Now',
  description = 'Side-by-side primary and secondary buttons catering to self-serve and high-touch buyers.',
...
export default Ctas08_TwoTierActionChoice;
