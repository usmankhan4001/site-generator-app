...
export interface Ctas02_NewsletterSubscriptionProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas02_NewsletterSubscription: React.FC<Ctas02_NewsletterSubscriptionProps> = ({
  badge = 'Executive Briefing',
  headline = 'Newsletter & Weekly Market Intelligence',
  description = 'Single-input newsletter capture designed to grow enterprise email subscriber lists.',
...
export default Ctas02_NewsletterSubscription;
