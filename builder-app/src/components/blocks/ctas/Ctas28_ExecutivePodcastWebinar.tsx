...
export interface Ctas28_ExecutivePodcastWebinarProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas28_ExecutivePodcastWebinar: React.FC<Ctas28_ExecutivePodcastWebinarProps> = ({
  badge = 'Upcoming Webinar',
  headline = 'Register for FinTech Leadership Webinar',
  description = 'Live event RSVP block featuring guest speakers from leading global banks.',
...
export default Ctas28_ExecutivePodcastWebinar;
