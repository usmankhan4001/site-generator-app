...
export interface Ctas16_ContactSalesSplitCardProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas16_ContactSalesSplitCard: React.FC<Ctas16_ContactSalesSplitCardProps> = ({
  badge = 'Sales Advisory',
  headline = 'Split Contact Sales & Schedule Walkthrough',
  description = 'Direct form inputs embedded inside a conversion card for sub-5-minute sales contact.',
...
export default Ctas16_ContactSalesSplitCard;
