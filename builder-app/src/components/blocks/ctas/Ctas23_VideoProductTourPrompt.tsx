...
export interface Ctas23_VideoProductTourPromptProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Ctas23_VideoProductTourPrompt: React.FC<Ctas23_VideoProductTourPromptProps> = ({
  badge = 'Guided Walkthrough',
  headline = 'Watch 3-Minute Architectural Tour',
  description = 'Visual video modal trigger showing real-time dashboard operations.',
...
export default Ctas23_VideoProductTourPrompt;
