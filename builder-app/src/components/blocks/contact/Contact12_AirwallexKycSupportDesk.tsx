...
export interface Contact12_AirwallexKycSupportDeskProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact12_AirwallexKycSupportDesk: React.FC<Contact12_AirwallexKycSupportDeskProps> = ({
  badge = 'Underwriting Support',
  headline = 'Airwallex Underwriting Concierge Desk',
  description = 'Dedicated portal for document submissions, business registration, and bank verification.',
...
export default Contact12_AirwallexKycSupportDesk;
