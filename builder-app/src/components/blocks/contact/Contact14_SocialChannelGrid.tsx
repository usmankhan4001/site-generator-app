...
export interface Contact14_SocialChannelGridProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact14_SocialChannelGrid: React.FC<Contact14_SocialChannelGridProps> = ({
  badge = 'Connect Anywhere',
  headline = 'Official Social & Direct Chat Grid',
  description = 'Direct links to verified corporate LinkedIn, GitHub, X, and Discord channels.',
...
export default Contact14_SocialChannelGrid;
