...
export interface Contact23_BespokePartnershipProposalProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact23_BespokePartnershipProposal: React.FC<Contact23_BespokePartnershipProposalProps> = ({
  badge = 'Partner With Us',
  headline = 'Strategic Partnerships & Alliances Desk',
  description = 'Channel partner proposal form with API co-marketing and integration details.',
...
export default Contact23_BespokePartnershipProposal;
