...
export interface Contact18_PhysicalHQVisitorGuideProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact18_PhysicalHQVisitorGuide: React.FC<Contact18_PhysicalHQVisitorGuideProps> = ({
  badge = 'Visit Our Offices',
  headline = 'Corporate Headquarters Visitor Guide',
  description = 'Visitor instructions, building security badges, parking options, and transit links.',
...
export default Contact18_PhysicalHQVisitorGuide;
