...
export interface Contact07_DirectDepartmentRoutingProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact07_DirectDepartmentRouting: React.FC<Contact07_DirectDepartmentRoutingProps> = ({
  badge = 'Department Routing',
  headline = 'Multi-Department Inquiry Selector',
  description = 'Form featuring direct routing to Sales, Support, Compliance, or Legal counsel.',
...
export default Contact07_DirectDepartmentRouting;
