...
export interface Contact11_RfqQuoteConfiguratorProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact11_RfqQuoteConfigurator: React.FC<Contact11_RfqQuoteConfiguratorProps> = ({
  badge = 'Configure RFQ',
  headline = 'Interactive Request For Quote (RFQ)',
  description = 'Multi-step questionnaire capturing project scope, monthly volume, and timeline.',
...
export default Contact11_RfqQuoteConfigurator;
