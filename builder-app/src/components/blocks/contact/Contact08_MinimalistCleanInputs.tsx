...
export interface Contact08_MinimalistCleanInputsProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact08_MinimalistCleanInputs: React.FC<Contact08_MinimalistCleanInputsProps> = ({
  badge = 'Clean & Simple',
  headline = 'Minimalist Clean Contact Card',
  description = 'Streamlined name, email, and message inputs designed for minimal conversion friction.',
...
export default Contact08_MinimalistCleanInputs;
