...
export interface Contact22_VendorProcurementPortalProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact22_VendorProcurementPortal: React.FC<Contact22_VendorProcurementPortalProps> = ({
  badge = 'Vendor Invoices',
  headline = 'Vendor Procurement & Accounts Payable',
  description = 'Invoicing submission, purchase order matching, and finance remittance routing.',
...
export default Contact22_VendorProcurementPortal;
