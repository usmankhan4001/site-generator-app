...
export interface Contact01_TwoColWithMapProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact01_TwoColWithMap: React.FC<Contact01_TwoColWithMapProps> = ({
  badge = 'Reach Out',
  headline = '2-Column Office Address & Map',
  description = 'Official registered address details paired with an interactive map container.',
...
export default Contact01_TwoColWithMap;
