...
export interface Contact03_MeetingBookingWidgetProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact03_MeetingBookingWidget: React.FC<Contact03_MeetingBookingWidgetProps> = ({
  badge = 'Schedule Briefing',
  headline = 'Executive Meeting Booking & Cal',
  description = 'Integrated calendar picker simulating direct executive consultation scheduling.',
...
export default Contact03_MeetingBookingWidget;
