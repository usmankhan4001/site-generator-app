...
export interface Contact20_InvestorRelationsDeskProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact20_InvestorRelationsDesk: React.FC<Contact20_InvestorRelationsDeskProps> = ({
  badge = 'Investor Relations',
  headline = 'Institutional Investor Relations Desk',
  description = 'Cap table inquiries, quarterly earnings deck requests, and board liaison desk.',
...
export default Contact20_InvestorRelationsDesk;
