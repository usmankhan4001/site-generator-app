...
export interface Contact06_FloatingChatTriggerProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact06_FloatingChatTrigger: React.FC<Contact06_FloatingChatTriggerProps> = ({
  badge = 'Live Concierge',
  headline = 'Floating Instant Concierge Hub',
  description = 'Contact module emphasizing direct WhatsApp, Telegram, and Live Chat connections.',
...
export default Contact06_FloatingChatTrigger;
