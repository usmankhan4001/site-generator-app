...
export interface Contact02_FormspreeLeadRouterProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact02_FormspreeLeadRouter: React.FC<Contact02_FormspreeLeadRouterProps> = ({
  badge = 'Instant Inquiry',
  headline = 'Formspree Lead Routing Form',
  description = 'Ready-to-connect contact form with automated webhook routing and validation.',
...
export default Contact02_FormspreeLeadRouter;
