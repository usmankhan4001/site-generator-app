...
export interface Contact25_DirectWhatsappButtonHeroProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact25_DirectWhatsappButtonHero: React.FC<Contact25_DirectWhatsappButtonHeroProps> = ({
  badge = 'Instant Messenger',
  headline = 'Instant WhatsApp & Telegram Chat Hero',
  description = 'Direct click-to-chat buttons triggering instant mobile messenger consultations.',
...
export default Contact25_DirectWhatsappButtonHero;
