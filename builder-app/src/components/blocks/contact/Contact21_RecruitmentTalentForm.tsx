...
export interface Contact21_RecruitmentTalentFormProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact21_RecruitmentTalentForm: React.FC<Contact21_RecruitmentTalentFormProps> = ({
  badge = 'Join the Team',
  headline = 'Careers & Talent Application Desk',
  description = 'Direct resume upload, LinkedIn portfolio link, and engineering role inquiries.',
...
export default Contact21_RecruitmentTalentForm;
