...
export interface Contact24_MultiLocationDirectoryProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact24_MultiLocationDirectory: React.FC<Contact24_MultiLocationDirectoryProps> = ({
  badge = 'Worldwide Locations',
  headline = 'Global Multi-City Office Directory',
  description = 'Tabs toggling addresses in Singapore, Hong Kong, London, Frankfurt, and San Francisco.',
...
export default Contact24_MultiLocationDirectory;
