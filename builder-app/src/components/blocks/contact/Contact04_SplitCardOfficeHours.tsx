...
export interface Contact04_SplitCardOfficeHoursProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Contact04_SplitCardOfficeHours: React.FC<Contact04_SplitCardOfficeHoursProps> = ({
  badge = 'Global Offices',
  headline = 'Office Hours & Global Directory',
  description = 'Regional office directories with local operating hours across Singapore, London, and NY.',
...
export default Contact04_SplitCardOfficeHours;
