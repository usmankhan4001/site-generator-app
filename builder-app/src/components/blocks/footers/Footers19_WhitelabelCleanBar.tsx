...
export interface Footers19_WhitelabelCleanBarProps {
  companyName?: string;
...
export const Footers19_WhitelabelCleanBar: React.FC<Footers19_WhitelabelCleanBarProps> = ({
...
export default Footers19_WhitelabelCleanBar;
