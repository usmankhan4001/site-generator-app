...
export interface Footers18_BackToTopFloatingProps {
  companyName?: string;
...
export const Footers18_BackToTopFloating: React.FC<Footers18_BackToTopFloatingProps> = ({
...
export default Footers18_BackToTopFloating;
