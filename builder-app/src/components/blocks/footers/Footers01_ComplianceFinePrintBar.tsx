...
export interface Footers01_ComplianceFinePrintBarProps {
  companyName?: string;
...
export const Footers01_ComplianceFinePrintBar: React.FC<Footers01_ComplianceFinePrintBarProps> = ({
...
export default Footers01_ComplianceFinePrintBar;
