...
export interface Footers08_NewsletterEmbeddedProps {
  companyName?: string;
...
export const Footers08_NewsletterEmbedded: React.FC<Footers08_NewsletterEmbeddedProps> = ({
...
export default Footers08_NewsletterEmbedded;
