...
export interface Footers25_ModernGlassmorphicProps {
  companyName?: string;
...
export const Footers25_ModernGlassmorphic: React.FC<Footers25_ModernGlassmorphicProps> = ({
...
export default Footers25_ModernGlassmorphic;
