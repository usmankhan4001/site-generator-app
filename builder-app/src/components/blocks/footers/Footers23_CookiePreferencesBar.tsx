...
export interface Footers23_CookiePreferencesBarProps {
  companyName?: string;
...
export const Footers23_CookiePreferencesBar: React.FC<Footers23_CookiePreferencesBarProps> = ({
...
export default Footers23_CookiePreferencesBar;
