...
export interface Footers09_MultiLanguageCurrencyProps {
  companyName?: string;
...
export const Footers09_MultiLanguageCurrency: React.FC<Footers09_MultiLanguageCurrencyProps> = ({
...
export default Footers09_MultiLanguageCurrency;
