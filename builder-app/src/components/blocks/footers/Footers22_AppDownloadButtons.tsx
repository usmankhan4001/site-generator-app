...
export interface Footers22_AppDownloadButtonsProps {
  companyName?: string;
...
export const Footers22_AppDownloadButtons: React.FC<Footers22_AppDownloadButtonsProps> = ({
...
export default Footers22_AppDownloadButtons;
