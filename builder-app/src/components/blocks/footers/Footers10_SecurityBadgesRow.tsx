...
export interface Footers10_SecurityBadgesRowProps {
  companyName?: string;
...
export const Footers10_SecurityBadgesRow: React.FC<Footers10_SecurityBadgesRowProps> = ({
...
export default Footers10_SecurityBadgesRow;
