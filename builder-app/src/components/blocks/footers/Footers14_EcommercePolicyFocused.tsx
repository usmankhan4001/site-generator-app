...
export interface Footers14_EcommercePolicyFocusedProps {
  companyName?: string;
...
export const Footers14_EcommercePolicyFocused: React.FC<Footers14_EcommercePolicyFocusedProps> = ({
...
export default Footers14_EcommercePolicyFocused;
