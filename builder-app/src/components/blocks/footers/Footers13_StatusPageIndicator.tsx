...
export interface Footers13_StatusPageIndicatorProps {
  companyName?: string;
...
export const Footers13_StatusPageIndicator: React.FC<Footers13_StatusPageIndicatorProps> = ({
...
export default Footers13_StatusPageIndicator;
