...
export interface Footers21_SimpleCopyrightOnlyProps {
  companyName?: string;
...
export const Footers21_SimpleCopyrightOnly: React.FC<Footers21_SimpleCopyrightOnlyProps> = ({
...
export default Footers21_SimpleCopyrightOnly;
