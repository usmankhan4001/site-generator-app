...
export interface Footers15_SaaSAppCompactProps {
  companyName?: string;
...
export const Footers15_SaaSAppCompact: React.FC<Footers15_SaaSAppCompactProps> = ({
...
export default Footers15_SaaSAppCompact;
