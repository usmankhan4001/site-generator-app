...
export interface Footers04_DarkHighContrastProps {
  companyName?: string;
...
export const Footers04_DarkHighContrast: React.FC<Footers04_DarkHighContrastProps> = ({
...
export default Footers04_DarkHighContrast;
