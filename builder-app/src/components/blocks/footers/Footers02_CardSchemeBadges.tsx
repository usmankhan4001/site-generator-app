...
export interface Footers02_CardSchemeBadgesProps {
  companyName?: string;
...
export const Footers02_CardSchemeBadges: React.FC<Footers02_CardSchemeBadgesProps> = ({
...
export default Footers02_CardSchemeBadges;
