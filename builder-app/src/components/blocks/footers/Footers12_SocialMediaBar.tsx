...
export interface Footers12_SocialMediaBarProps {
  companyName?: string;
...
export const Footers12_SocialMediaBar: React.FC<Footers12_SocialMediaBarProps> = ({
...
export default Footers12_SocialMediaBar;
