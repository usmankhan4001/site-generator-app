...
export interface Footers07_CentredMinimalistProps {
  companyName?: string;
...
export const Footers07_CentredMinimalist: React.FC<Footers07_CentredMinimalistProps> = ({
...
export default Footers07_CentredMinimalist;
