...
export interface Footers06_LegalDisclaimersExpandedProps {
  companyName?: string;
...
export const Footers06_LegalDisclaimersExpanded: React.FC<Footers06_LegalDisclaimersExpandedProps> = ({
...
export default Footers06_LegalDisclaimersExpanded;
