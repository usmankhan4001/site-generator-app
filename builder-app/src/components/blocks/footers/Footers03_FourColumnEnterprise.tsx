...
export interface Footers03_FourColumnEnterpriseProps {
  companyName?: string;
...
export const Footers03_FourColumnEnterprise: React.FC<Footers03_FourColumnEnterpriseProps> = ({
...
export default Footers03_FourColumnEnterprise;
