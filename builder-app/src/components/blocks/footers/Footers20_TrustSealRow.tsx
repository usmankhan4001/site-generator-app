...
export interface Footers20_TrustSealRowProps {
  companyName?: string;
...
export const Footers20_TrustSealRow: React.FC<Footers20_TrustSealRowProps> = ({
...
export default Footers20_TrustSealRow;
