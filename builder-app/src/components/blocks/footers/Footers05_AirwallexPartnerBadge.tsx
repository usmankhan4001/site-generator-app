...
export interface Footers05_AirwallexPartnerBadgeProps {
  companyName?: string;
...
export const Footers05_AirwallexPartnerBadge: React.FC<Footers05_AirwallexPartnerBadgeProps> = ({
...
export default Footers05_AirwallexPartnerBadge;
