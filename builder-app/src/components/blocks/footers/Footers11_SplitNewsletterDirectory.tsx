...
export interface Footers11_SplitNewsletterDirectoryProps {
  companyName?: string;
...
export const Footers11_SplitNewsletterDirectory: React.FC<Footers11_SplitNewsletterDirectoryProps> = ({
...
export default Footers11_SplitNewsletterDirectory;
