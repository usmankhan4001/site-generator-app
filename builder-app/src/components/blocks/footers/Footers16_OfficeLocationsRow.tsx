...
export interface Footers16_OfficeLocationsRowProps {
  companyName?: string;
...
export const Footers16_OfficeLocationsRow: React.FC<Footers16_OfficeLocationsRowProps> = ({
...
export default Footers16_OfficeLocationsRow;
