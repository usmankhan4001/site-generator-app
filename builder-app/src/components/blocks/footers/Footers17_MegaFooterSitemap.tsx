...
export interface Footers17_MegaFooterSitemapProps {
  companyName?: string;
...
export const Footers17_MegaFooterSitemap: React.FC<Footers17_MegaFooterSitemapProps> = ({
...
export default Footers17_MegaFooterSitemap;
