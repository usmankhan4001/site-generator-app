...
export interface Testimonials21_CardSliderControlsProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials21_CardSliderControls: React.FC<Testimonials21_CardSliderControlsProps> = ({
  badge = 'Browse Reviews',
  headline = 'Interactive Card Slider with Nav',
  description = 'Carousel container with clean arrow buttons and active progress indicator pills.',
  items = [
    {
...
export default Testimonials21_CardSliderControls;
