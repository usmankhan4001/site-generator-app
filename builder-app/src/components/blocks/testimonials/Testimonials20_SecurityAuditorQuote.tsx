...
export interface Testimonials20_SecurityAuditorQuoteProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials20_SecurityAuditorQuote: React.FC<Testimonials20_SecurityAuditorQuoteProps> = ({
  badge = 'Institutional Security',
  headline = 'SOC2 Auditor & Security Endorsement',
  description = 'Testimonials from third-party cybersecurity auditors praising zero-vulnerability posture.',
  items = [
    {
...
export default Testimonials20_SecurityAuditorQuote;
