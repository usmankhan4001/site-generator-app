...
export interface Testimonials28_BeforeAfterNarrativeProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials28_BeforeAfterNarrative: React.FC<Testimonials28_BeforeAfterNarrativeProps> = ({
  badge = 'Seamless Migration',
  headline = 'Before vs After Platform Migration',
  description = 'Side-by-side comparison detailing life before and after zero-downtime migration.',
  items = [
    {
...
export default Testimonials28_BeforeAfterNarrative;
