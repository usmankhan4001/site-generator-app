...
export interface Testimonials14_FounderLetterStatementProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials14_FounderLetterStatement: React.FC<Testimonials14_FounderLetterStatementProps> = ({
  badge = 'Founder to Founder',
  headline = 'Personal Letter of Recommendation',
  description = 'Signed personal open letter praising platform stability, onboarding ease, and support speed.',
  items = [
    {
...
export default Testimonials14_FounderLetterStatement;
