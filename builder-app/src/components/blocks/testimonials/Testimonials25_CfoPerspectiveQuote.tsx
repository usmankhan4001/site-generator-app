...
export interface Testimonials25_CfoPerspectiveQuoteProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials25_CfoPerspectiveQuote: React.FC<Testimonials25_CfoPerspectiveQuoteProps> = ({
  badge = 'Financial Efficiency',
  headline = 'CFO Operational Cost Reduction',
  description = 'Finance executive praising 40% reduction in international wire and FX transaction fees.',
  items = [
    {
...
export default Testimonials25_CfoPerspectiveQuote;
