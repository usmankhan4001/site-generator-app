...
export interface Testimonials22_SpeechBubbleCardsProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials22_SpeechBubbleCards: React.FC<Testimonials22_SpeechBubbleCardsProps> = ({
  badge = 'Community Voice',
  headline = 'Playful Speech Bubble Reviews',
  description = 'Conversational speech bubble geometry featuring friendly user avatars and timestamps.',
  items = [
    {
...
export default Testimonials22_SpeechBubbleCards;
