...
export interface Testimonials23_KycSuccessStoryProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials23_KycSuccessStory: React.FC<Testimonials23_KycSuccessStoryProps> = ({
  badge = 'Compliance Story',
  headline = 'Fast-Track KYC Approval Showcase',
  description = 'Merchant narrative celebrating painless, 2-hour underwriting approval on Airwallex rails.',
  items = [
    {
...
export default Testimonials23_KycSuccessStory;
