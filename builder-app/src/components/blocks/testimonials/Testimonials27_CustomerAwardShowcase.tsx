...
export interface Testimonials27_CustomerAwardShowcaseProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials27_CustomerAwardShowcase: React.FC<Testimonials27_CustomerAwardShowcaseProps> = ({
  badge = 'Industry Recognition',
  headline = 'Merchant Innovation Award Finalist',
  description = 'Customer quote celebrating mutual recognition at the Global FinTech Innovation Awards.',
  items = [
    {
...
export default Testimonials27_CustomerAwardShowcase;
