...
export interface Testimonials04_CustomerMetricsHighlightProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials04_CustomerMetricsHighlight: React.FC<Testimonials04_CustomerMetricsHighlightProps> = ({
  badge = 'Proven ROI',
  headline = 'Case Study ROI & Metric Cards',
  description = 'Testimonial cards that prominently emphasize real client ROI and growth multipliers.',
  items = [
    {
...
export default Testimonials04_CustomerMetricsHighlight;
