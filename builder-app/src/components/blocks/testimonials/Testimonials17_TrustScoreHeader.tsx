...
export interface Testimonials17_TrustScoreHeaderProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials17_TrustScoreHeader: React.FC<Testimonials17_TrustScoreHeaderProps> = ({
  badge = 'High Satisfaction',
  headline = 'TrustScore Header & Customer Grid',
  description = 'Header scorecard showing 99.8% customer retention over 3 consecutive years.',
  items = [
    {
...
export default Testimonials17_TrustScoreHeader;
