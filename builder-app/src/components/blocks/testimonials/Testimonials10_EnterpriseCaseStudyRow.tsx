...
export interface Testimonials10_EnterpriseCaseStudyRowProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials10_EnterpriseCaseStudyRow: React.FC<Testimonials10_EnterpriseCaseStudyRowProps> = ({
  badge = 'Financial Sector',
  headline = 'Deep-Dive Enterprise Case Study',
  description = 'Comprehensive case study breaking down Challenge, Solution, and Measurable Outcomes.',
  items = [
    {
...
export default Testimonials10_EnterpriseCaseStudyRow;
