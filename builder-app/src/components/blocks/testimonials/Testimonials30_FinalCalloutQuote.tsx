...
export interface Testimonials30_FinalCalloutQuoteProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials30_FinalCalloutQuote: React.FC<Testimonials30_FinalCalloutQuoteProps> = ({
  badge = 'Final Reassurance',
  headline = 'Conversion-Driving Bottom Testimonial',
  description = 'Last-mile confidence-building review positioned right above the main checkout CTA.',
  items = [
    {
...
export default Testimonials30_FinalCalloutQuote;
