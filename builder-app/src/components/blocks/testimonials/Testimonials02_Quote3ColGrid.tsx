...
export interface Testimonials02_Quote3ColGridProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials02_Quote3ColGrid: React.FC<Testimonials02_Quote3ColGridProps> = ({
  badge = 'Client Validation',
  headline = '3-Column Verified Reviews Grid',
  description = 'Balanced 3-column card grid with star ratings, client names, and verified purchase tags.',
  items = [
    {
...
export default Testimonials02_Quote3ColGrid;
