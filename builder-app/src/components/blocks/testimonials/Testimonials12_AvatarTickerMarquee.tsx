...
export interface Testimonials12_AvatarTickerMarqueeProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials12_AvatarTickerMarquee: React.FC<Testimonials12_AvatarTickerMarqueeProps> = ({
  badge = 'Global Momentum',
  headline = 'Continuous Client Review Marquee',
  description = 'Smooth scrolling horizontal tape of rapid-fire positive customer micro-reviews.',
  items = [
    {
...
export default Testimonials12_AvatarTickerMarquee;
