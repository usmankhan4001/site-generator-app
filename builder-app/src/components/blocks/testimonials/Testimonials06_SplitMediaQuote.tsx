...
export interface Testimonials06_SplitMediaQuoteProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials06_SplitMediaQuote: React.FC<Testimonials06_SplitMediaQuoteProps> = ({
  badge = 'Enterprise Impact',
  headline = 'Split Image & Customer Quote',
  description = 'Editorial two-column block with candid customer office photography and pull quote.',
  items = [
    {
...
export default Testimonials06_SplitMediaQuote;
