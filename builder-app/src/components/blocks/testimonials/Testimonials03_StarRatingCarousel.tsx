...
export interface Testimonials03_StarRatingCarouselProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials03_StarRatingCarousel: React.FC<Testimonials03_StarRatingCarouselProps> = ({
  badge = '5-Star Excellence',
  headline = 'Star Rating Carousel Block',
  description = 'Dynamic customer carousel highlighting 5-star merchant feedback with platform badges.',
  items = [
    {
...
export default Testimonials03_StarRatingCarousel;
