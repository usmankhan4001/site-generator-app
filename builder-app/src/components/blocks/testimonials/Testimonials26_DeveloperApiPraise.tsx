...
export interface Testimonials26_DeveloperApiPraiseProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials26_DeveloperApiPraise: React.FC<Testimonials26_DeveloperApiPraiseProps> = ({
  badge = 'Developer Loved',
  headline = 'Lead Architect & API Ergonomics',
  description = 'Software engineering lead complimenting clean REST APIs, SDKs, and webhook guarantees.',
  items = [
    {
...
export default Testimonials26_DeveloperApiPraise;
