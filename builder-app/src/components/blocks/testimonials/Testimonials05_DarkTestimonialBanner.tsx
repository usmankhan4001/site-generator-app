...
export interface Testimonials05_DarkTestimonialBannerProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials05_DarkTestimonialBanner: React.FC<Testimonials05_DarkTestimonialBannerProps> = ({
  badge = 'Featured Founder',
  headline = 'Dark Contrast Testimonial Hero',
  description = 'Full-width dark backdrop spotlighting a transformative customer case study.',
  items = [
    {
...
export default Testimonials05_DarkTestimonialBanner;
