...
export interface Testimonials09_MasonrySocialWallProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials09_MasonrySocialWall: React.FC<Testimonials09_MasonrySocialWallProps> = ({
  badge = 'Industry Buzz',
  headline = 'Social Proof Masonry Wall',
  description = 'Masonry feed style cards simulating genuine customer posts from X, LinkedIn, and Slack.',
  items = [
    {
...
export default Testimonials09_MasonrySocialWall;
