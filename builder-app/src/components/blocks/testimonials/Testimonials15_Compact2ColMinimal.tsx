...
export interface Testimonials15_Compact2ColMinimalProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials15_Compact2ColMinimal: React.FC<Testimonials15_Compact2ColMinimalProps> = ({
  badge = 'Subtle Proof',
  headline = 'Compact 2-Column Minimal Reviews',
  description = 'Clean, space-efficient review cards designed for high-density checkout and landing pages.',
  items = [
    {
...
export default Testimonials15_Compact2ColMinimal;
