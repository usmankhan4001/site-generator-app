...
export interface Testimonials18_CustomerMapPinpointsProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials18_CustomerMapPinpoints: React.FC<Testimonials18_CustomerMapPinpointsProps> = ({
  badge = 'Worldwide Reach',
  headline = 'Global Client Geolocation Quotes',
  description = 'Regional testimonials spanning London, Singapore, New York, Tokyo, and Sydney.',
  items = [
    {
...
export default Testimonials18_CustomerMapPinpoints;
