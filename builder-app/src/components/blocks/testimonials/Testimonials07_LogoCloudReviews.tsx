...
export interface Testimonials07_LogoCloudReviewsProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials07_LogoCloudReviews: React.FC<Testimonials07_LogoCloudReviewsProps> = ({
  badge = 'Third-Party Verified',
  headline = 'Verified G2 & Trustpilot Aggregate',
  description = 'Scorecard summarizing 4.9/5 satisfaction scores across Trustpilot, G2, and Capterra.',
  items = [
    {
...
export default Testimonials07_LogoCloudReviews;
