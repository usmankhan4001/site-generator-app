...
export interface Testimonials13_IndustrySpecificTabsProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials13_IndustrySpecificTabs: React.FC<Testimonials13_IndustrySpecificTabsProps> = ({
  badge = 'Targeted Proof',
  headline = 'Sector Filterable Testimonials',
  description = 'Interactive tabs sorting testimonials by E-Commerce, SaaS, Retail, and Web3 sectors.',
  items = [
    {
...
export default Testimonials13_IndustrySpecificTabs;
