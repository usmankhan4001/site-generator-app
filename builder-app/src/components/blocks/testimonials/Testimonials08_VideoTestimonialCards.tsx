...
export interface Testimonials08_VideoTestimonialCardsProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials08_VideoTestimonialCards: React.FC<Testimonials08_VideoTestimonialCardsProps> = ({
  badge = 'Video Interviews',
  headline = 'Video Case Study Thumbnails',
  description = 'Interactive video player cards featuring customer interviews and play button overlays.',
  items = [
    {
...
export default Testimonials08_VideoTestimonialCards;
