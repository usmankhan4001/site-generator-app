...
export interface Testimonials24_B2CMerchantSpotlightProps {
  badge?: string;
  headline?: string;
  description?: string;
  items?: Array<{
...
export const Testimonials24_B2CMerchantSpotlight: React.FC<Testimonials24_B2CMerchantSpotlightProps> = ({
  badge = 'Retail Velocity',
  headline = 'Physical Goods Brand Success Story',
  description = 'E-commerce merchant review highlighting zero dropped carts and checkout acceleration.',
  items = [
    {
...
export default Testimonials24_B2CMerchantSpotlight;
