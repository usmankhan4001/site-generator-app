...
export interface Faqs12_MultiColumnMinimalProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs12_MultiColumnMinimal: React.FC<Faqs12_MultiColumnMinimalProps> = ({
  badge = 'Direct Overview',
  headline = '3-Column Minimal Text FAQs',
  description = 'Clean editorial typography layout ideal for corporate and legal compliance overviews.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs12_MultiColumnMinimal;
