...
export interface Faqs05_BorderedCardGridProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs05_BorderedCardGrid: React.FC<Faqs05_BorderedCardGridProps> = ({
  badge = 'Quick Answers',
  headline = 'Bordered Grid Question Tiles',
  description = 'Open question-and-answer cards providing immediate visibility without clicking.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs05_BorderedCardGrid;
