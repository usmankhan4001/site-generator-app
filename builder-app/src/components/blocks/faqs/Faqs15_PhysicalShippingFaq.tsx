...
export interface Faqs15_PhysicalShippingFaqProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs15_PhysicalShippingFaq: React.FC<Faqs15_PhysicalShippingFaqProps> = ({
  badge = 'Logistics FAQ',
  headline = 'Physical Goods Shipping & RMA Returns',
  description = 'Carrier tracking, cross-border customs declarations, and warehouse restocking steps.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs15_PhysicalShippingFaq;
