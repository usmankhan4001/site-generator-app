...
export interface Faqs08_TechnicalIntegrationFaqProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs08_TechnicalIntegrationFaq: React.FC<Faqs08_TechnicalIntegrationFaqProps> = ({
  badge = 'API & Webhooks',
  headline = 'Developer & Webhook Integration',
  description = 'Security, TLS 1.3 encryption, sandbox credentials, and automated retry policies.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs08_TechnicalIntegrationFaq;
