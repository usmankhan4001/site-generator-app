...
export interface Faqs13_CardAccordionBorderedProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs13_CardAccordionBordered: React.FC<Faqs13_CardAccordionBorderedProps> = ({
  badge = 'Modular Cards',
  headline = 'Independent Card Accordions',
  description = 'Each question enclosed in an individual elevated card for visual separation.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs13_CardAccordionBordered;
