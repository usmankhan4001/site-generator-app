...
export interface Faqs20_FullWidthExpansionHeroProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs20_FullWidthExpansionHero: React.FC<Faqs20_FullWidthExpansionHeroProps> = ({
  badge = 'Comprehensive Index',
  headline = 'Full-Width Hero Expansion FAQ',
  description = 'Expansive knowledge base block with embedded ticket creation form trigger.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs20_FullWidthExpansionHero;
