...
export interface Faqs02_TwoColumnSearchableProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs02_TwoColumnSearchable: React.FC<Faqs02_TwoColumnSearchableProps> = ({
  badge = 'Knowledge Base',
  headline = '2-Column Searchable FAQ Cards',
  description = 'Search-enabled card grid that instantly filters questions by keyword.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs02_TwoColumnSearchable;
