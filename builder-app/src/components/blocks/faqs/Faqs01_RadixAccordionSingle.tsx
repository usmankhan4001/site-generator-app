...
export interface Faqs01_RadixAccordionSingleProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs01_RadixAccordionSingle: React.FC<Faqs01_RadixAccordionSingleProps> = ({
  badge = 'Frequently Asked',
  headline = 'Single-Column Clean Accordion',
  description = 'Accessible smooth expandable accordion with subtle chevron transitions.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs01_RadixAccordionSingle;
