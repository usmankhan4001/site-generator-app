...
export interface Faqs18_ComplianceGdprFaqProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs18_ComplianceGdprFaq: React.FC<Faqs18_ComplianceGdprFaqProps> = ({
  badge = 'Data Privacy',
  headline = 'GDPR, CCPA & Data Privacy Controls',
  description = 'Data sovereignty, encryption-at-rest keys, and right-to-be-forgotten protocols.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs18_ComplianceGdprFaq;
