...
export interface Faqs14_SlaUptimeQuestionsProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs14_SlaUptimeQuestions: React.FC<Faqs14_SlaUptimeQuestionsProps> = ({
  badge = 'Operational SLA',
  headline = 'SLA, High Availability & Disaster Recovery',
  description = 'Data redundancy, multi-region failover, and contractual credit compensations.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs14_SlaUptimeQuestions;
