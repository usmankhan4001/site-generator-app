...
export interface Faqs06_AirwallexKycSpecificProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs06_AirwallexKycSpecific: React.FC<Faqs06_AirwallexKycSpecificProps> = ({
  badge = 'KYC & Underwriting',
  headline = 'Statutory Airwallex & KYC Guidance',
  description = 'Detailed explanations of company registration, UBO proof, and bank statement verification.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs06_AirwallexKycSpecific;
