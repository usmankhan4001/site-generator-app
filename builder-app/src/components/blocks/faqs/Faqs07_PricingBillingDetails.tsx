...
export interface Faqs07_PricingBillingDetailsProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs07_PricingBillingDetails: React.FC<Faqs07_PricingBillingDetailsProps> = ({
  badge = 'Commercial Terms',
  headline = 'Billing & Refund Clarifications',
  description = 'Clear terms on currency conversions, recurring invoicing, and 30-day money-back claims.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs07_PricingBillingDetails;
