...
export interface Faqs04_CategoryTabbedAccordionProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs04_CategoryTabbedAccordion: React.FC<Faqs04_CategoryTabbedAccordionProps> = ({
  badge = 'Categorized Help',
  headline = 'Category-Tabbed FAQs',
  description = 'Segmented navigation for General, Billing, Technical Architecture, and Compliance.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs04_CategoryTabbedAccordion;
