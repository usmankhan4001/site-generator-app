...
export interface Faqs17_ConsultationMeetingFaqProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs17_ConsultationMeetingFaq: React.FC<Faqs17_ConsultationMeetingFaqProps> = ({
  badge = 'Custom Solutions',
  headline = 'Advisory & Enterprise Pilot FAQs',
  description = 'Timeline expectations for institutional pilot scoping and engineering support.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs17_ConsultationMeetingFaq;
