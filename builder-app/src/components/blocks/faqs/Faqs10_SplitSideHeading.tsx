...
export interface Faqs10_SplitSideHeadingProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs10_SplitSideHeading: React.FC<Faqs10_SplitSideHeadingProps> = ({
  badge = 'Got Questions?',
  headline = 'Split Left Sticky Heading FAQ',
  description = 'Sticky left-hand guidance column with smooth scrolling right-hand answers list.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs10_SplitSideHeading;
