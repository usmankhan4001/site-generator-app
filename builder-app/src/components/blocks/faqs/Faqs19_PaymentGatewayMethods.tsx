...
export interface Faqs19_PaymentGatewayMethodsProps {
  badge?: string;
  headline?: string;
  description?: string;
...
export const Faqs19_PaymentGatewayMethods: React.FC<Faqs19_PaymentGatewayMethodsProps> = ({
  badge = 'Payment Channels',
  headline = 'Accepted Payment Methods & Card Schemes',
  description = 'Visa, Mastercard, AMEX, Apple Pay, Google Pay, and localized bank rails.',
  supportPrompt = true,
  items = [
    {
...
export default Faqs19_PaymentGatewayMethods;
