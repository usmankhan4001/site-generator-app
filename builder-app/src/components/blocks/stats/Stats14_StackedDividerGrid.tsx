...
export interface Stats14_StackedDividerGridProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats14_StackedDividerGrid: React.FC<Stats14_StackedDividerGridProps> = ({
  badge = 'Audited Telemetry',
  headline = 'Clear, Transparent Enterprise Figures',
  description = 'Structured row list with horizontal hairline borders and monospace numerical values.',
  stats = [
...
export default Stats14_StackedDividerGrid;
