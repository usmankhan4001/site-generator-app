...
export interface Stats16_AirwallexKycStatsProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats16_AirwallexKycStats: React.FC<Stats16_AirwallexKycStatsProps> = ({
  badge = 'KYC & Underwriting',
  headline = 'Airwallex Partner Settlement Metrics',
  description = 'Same-day settlement, 130+ local payout rails, and automated merchant compliance.',
  stats = [
...
export default Stats16_AirwallexKycStats;
