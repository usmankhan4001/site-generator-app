...
export interface Stats12_GlobalFootprintProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats12_GlobalFootprint: React.FC<Stats12_GlobalFootprintProps> = ({
  badge = 'Global Coverage',
  headline = 'Borderless Operations Across 180+ Markets',
  description = 'Worldwide settlement capability, cross-border multi-currency routes, and low-latency nodes.',
  stats = [
...
export default Stats12_GlobalFootprint;
