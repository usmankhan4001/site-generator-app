...
export interface Stats03_AccentBackgroundProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats03_AccentBackground: React.FC<Stats03_AccentBackgroundProps> = ({
  badge = 'Global Throughput',
  headline = 'Built for High-Frequency Commerce',
  description = 'Vibrant accent container designed for mid-page conversion reinforcement.',
  stats = [
...
export default Stats03_AccentBackground;
