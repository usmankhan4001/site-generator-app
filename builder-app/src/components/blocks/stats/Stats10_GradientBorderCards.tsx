...
export interface Stats10_GradientBorderCardsProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats10_GradientBorderCards: React.FC<Stats10_GradientBorderCardsProps> = ({
  badge = 'Next-Gen Core',
  headline = 'Accelerated Financial Architecture',
  description = 'Glassmorphism tiles surrounded by multi-tone gradient borders and soft shadows.',
  stats = [
...
export default Stats10_GradientBorderCards;
