...
export interface Stats15_GlassmorphicTilesProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats15_GlassmorphicTiles: React.FC<Stats15_GlassmorphicTilesProps> = ({
  badge = 'Modern Aero',
  headline = 'Next-Generation Settlement Velocity',
  description = 'Backdrop-blur frosted cards that seamlessly integrate with complex visual canvases.',
  stats = [
...
export default Stats15_GlassmorphicTiles;
