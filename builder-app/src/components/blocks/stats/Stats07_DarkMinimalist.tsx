...
export interface Stats07_DarkMinimalistProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats07_DarkMinimalist: React.FC<Stats07_DarkMinimalistProps> = ({
  badge = 'Dark Surface',
  headline = 'Institutional Precision in Dark Canvas',
  description = 'Deep zinc background with glowing neon accents and high contrast text.',
  stats = [
...
export default Stats07_DarkMinimalist;
