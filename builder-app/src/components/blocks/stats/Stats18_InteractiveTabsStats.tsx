...
export interface Stats18_InteractiveTabsStatsProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats18_InteractiveTabsStats: React.FC<Stats18_InteractiveTabsStatsProps> = ({
  badge = 'Interactive Breakdown',
  headline = 'Dynamic Metric Explorer by Business Unit',
  description = 'Tab-switched statistics highlighting Enterprise, Mid-Market, and Startup throughput.',
  stats = [
...
export default Stats18_InteractiveTabsStats;
