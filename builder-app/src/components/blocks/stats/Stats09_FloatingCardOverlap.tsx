...
export interface Stats09_FloatingCardOverlapProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats09_FloatingCardOverlap: React.FC<Stats09_FloatingCardOverlapProps> = ({
  badge = 'Hero Extension',
  headline = 'Continuous Network Throughput',
  description = 'Elevated floating card container that neatly bridges hero banners and content sections.',
  stats = [
...
export default Stats09_FloatingCardOverlap;
