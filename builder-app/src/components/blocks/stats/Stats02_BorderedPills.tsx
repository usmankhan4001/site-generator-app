...
export interface Stats02_BorderedPillsProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats02_BorderedPills: React.FC<Stats02_BorderedPillsProps> = ({
  badge = 'Real-Time Telemetry',
  headline = 'Trusted by Institutional Scalers',
  description = 'Pill-encapsulated metrics engineered with subtle border accents and active status dots.',
  stats = [
...
export default Stats02_BorderedPills;
