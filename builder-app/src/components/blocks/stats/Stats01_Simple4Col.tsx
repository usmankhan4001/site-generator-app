...
export interface Stats01_Simple4ColProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats01_Simple4Col: React.FC<Stats01_Simple4ColProps> = ({
  badge = 'Metrics Overview',
  headline = 'High-Impact Performance Benchmarks',
  description = 'Real-time telemetry and operational throughput metrics across all production environments.',
  stats = [
...
export default Stats01_Simple4Col;
