...
export interface Stats20_BannerWithCTAProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats20_BannerWithCTA: React.FC<Stats20_BannerWithCTAProps> = ({
  badge = 'Accelerate Today',
  headline = 'Ready to Process at Institutional Scale?',
  description = 'Cohesive stat presentation paired directly with a high-conversion onboarding button.',
  stats = [
...
export default Stats20_BannerWithCTA;
