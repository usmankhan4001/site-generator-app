...
export interface Stats06_SplitWithHeadingProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats06_SplitWithHeading: React.FC<Stats06_SplitWithHeadingProps> = ({
  badge = 'Operational Health',
  headline = 'Engineered for Global Reliability and Zero Downtime',
  description = 'Editorial side-by-side layout pairing narrative context with large numeric stats.',
  stats = [
...
export default Stats06_SplitWithHeading;
