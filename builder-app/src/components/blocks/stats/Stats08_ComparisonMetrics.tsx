...
export interface Stats08_ComparisonMetricsProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats08_ComparisonMetrics: React.FC<Stats08_ComparisonMetricsProps> = ({
  badge = 'Efficiency Gains',
  headline = 'Quantifiable Return on Infrastructure',
  description = 'Direct comparison against legacy banking rails and traditional merchant solutions.',
  stats = [
...
export default Stats08_ComparisonMetrics;
