...
export interface Stats11_KpiDeltaIndicatorsProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats11_KpiDeltaIndicators: React.FC<Stats11_KpiDeltaIndicatorsProps> = ({
  badge = 'Live KPI Feeds',
  headline = 'Month-Over-Month Acceleration',
  description = 'Financial KPI cards with color-coded positive delta tags and volatility indicators.',
  stats = [
...
export default Stats11_KpiDeltaIndicators;
