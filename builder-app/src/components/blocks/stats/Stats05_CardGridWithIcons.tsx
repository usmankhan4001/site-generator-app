...
export interface Stats05_CardGridWithIconsProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats05_CardGridWithIcons: React.FC<Stats05_CardGridWithIconsProps> = ({
  badge = 'System Reliability',
  headline = 'Enterprise Resiliency Benchmarks',
  description = 'Clean metric grid featuring Lucide iconography, percentage deltas, and audit tags.',
  stats = [
...
export default Stats05_CardGridWithIcons;
