...
export interface Stats13_CustomerTrustBarProps {
  badge?: string;
  headline?: string;
  description?: string;
  stats?: Array<{
...
export const Stats13_CustomerTrustBar: React.FC<Stats13_CustomerTrustBarProps> = ({
  badge = 'Trust & Ratings',
  headline = 'Validated by Market Leaders Worldwide',
  description = 'Aggregated CSAT, Net Promoter Score, G2 leader ratings, and Tier-1 audit reports.',
  stats = [
...
export default Stats13_CustomerTrustBar;
