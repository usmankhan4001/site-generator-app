...
import { ArrowLeft, ShieldCheck, Building2, MapPin, Mail, Phone } from 'lucide-react';
import { BUSINESS, getPrivacyPolicy } from '@/lib/constants';

export default function PrivacyPolicyPage() {
  const policyText = getPrivacyPolicy(BUSINESS);
