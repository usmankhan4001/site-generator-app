...
import { ArrowLeft, RefreshCw, Building2, MapPin, Mail, Phone } from 'lucide-react';
import { BUSINESS, getRefundPolicy } from '@/lib/constants';

export default function RefundPolicyPage() {
  const policyText = getRefundPolicy(BUSINESS);
