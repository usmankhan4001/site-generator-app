...
import { ArrowLeft, Truck, Building2, MapPin, Mail, Phone } from 'lucide-react';
import { BUSINESS, getShippingPolicy } from '@/lib/constants';

export default function ShippingPolicyPage() {
  const policyText = getShippingPolicy(BUSINESS);
